...
Nutshell - a local tool that turns a YouTube video into a trimmed, transcribed,
AI-summarized text asset. See `blueprint/project-plan.md` for the full problem
statement.
